...
{
    [Guid("b70ff430-8fc4-4424-abaf-ed3b9474f32c")]
    public class PluginServer : ApplicationAddInServer
    {
        ...
        {
            Trace.TraceInformation(": DAQuest4LoopsPlugin (" + Assembly.GetExecutingAssembly().GetName().Version.ToString(4) + "): initializing... ");
        ...
        {
            Trace.TraceInformation(": DAQuest4LoopsPlugin: deactivating... ");
